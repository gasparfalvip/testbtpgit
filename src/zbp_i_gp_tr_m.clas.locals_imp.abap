...
TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_gp_tr_m.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_features.
    ...
    READ ENTITY zi_gp_tr_m FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD validate_agency.
    ...
    READ ENTITY zi_gp_tr_m\\travel FROM VALUE #(
  ...
  METHOD calculatetravelkey.
    ...
    READ ENTITIES OF zi_gp_tr_m IN LOCAL MODE
      ENTITY Travel
        FIELDS ( travel_id )
  ...
  MODIFY ENTITIES OF zi_gp_tr_m IN LOCAL MODE
    ENTITY Travel
